...
define('C_NAME', "localhost"); // name of cluster, must be single name, e.g., HOST.INSTITUTE.EDU -> HOST

define('C_NODES_DEF', "1");// default number of requested nodes
define('C_NODES_MAX', "1"); // maximum number of requested nodes

define('C_PPN_DEF', "1"); // default processors per node
define('C_PPN_MAX', "1"); // maximum processors per node
define('C_RPROCS_DEF', "1"); // default reconstructions per node, a memory saving option

define('C_WALLTIME_DEF', "24"); // default Wall time in hours
define('C_WALLTIME_MAX', "24"); // maximum Wall time in hours
define('C_CPUTIME_DEF', "24"); // default CPU time in hours
