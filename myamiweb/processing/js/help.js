...
/******* IMAGIC terms ********/
		...
		'protomo_r1_corr_mode' : 'Correlation mode for Round 1, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl).<br><br>xcf: Conventional cross-correlation.<br><br>mcf: Mutual correlation function. mcf is less biased towards strong low-frequency components.<br><br>pcf: Phase only correlation function. pcf ignores the amplitude of the Fourier coefficients and only aligns based on phase. pcf might be useful in Refinements because it requires accurate geometric parameters as a starting point.<br><br>dbl: Phase doubled correlation. dbl doubles the peak shift allowing for more accurate alignments especially on tilt-series taken with poor imaging conditions.<br><br>Note: ccc values outputed to the command window by Protomo during alignment are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string selection).',
		'protomo_r2_corr_mode' : 'Correlation mode for Round 2, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl).<br><br>xcf: Conventional cross-correlation.<br><br>mcf: Mutual correlation function. mcf is less biased towards strong low-frequency components.<br><br>pcf: Phase only correlation function. pcf ignores the amplitude of the Fourier coefficients and only aligns based on phase. pcf might be useful in Refinements because it requires accurate geometric parameters as a starting point.<br><br>dbl: Phase doubled correlation. dbl doubles the peak shift allowing for more accurate alignments especially on tilt-series taken with poor imaging conditions.<br><br>Note: ccc values outputed to the command window by Protomo during alignment are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string selection).',
		'protomo_r3_corr_mode' : 'Correlation mode for Round 3, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl).<br><br>xcf: Conventional cross-correlation.<br><br>mcf: Mutual correlation function. mcf is less biased towards strong low-frequency components.<br><br>pcf: Phase only correlation function. pcf ignores the amplitude of the Fourier coefficients and only aligns based on phase. pcf might be useful in Refinements because it requires accurate geometric parameters as a starting point.<br><br>dbl: Phase doubled correlation. dbl doubles the peak shift allowing for more accurate alignments especially on tilt-series taken with poor imaging conditions.<br><br>Note: ccc values outputed to the command window by Protomo during alignment are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string selection).',
		'protomo_r4_corr_mode' : 'Correlation mode for Round 4, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl).<br><br>xcf: Conventional cross-correlation.<br><br>mcf: Mutual correlation function. mcf is less biased towards strong low-frequency components.<br><br>pcf: Phase only correlation function. pcf ignores the amplitude of the Fourier coefficients and only aligns based on phase. pcf might be useful in Refinements because it requires accurate geometric parameters as a starting point.<br><br>dbl: Phase doubled correlation. dbl doubles the peak shift allowing for more accurate alignments especially on tilt-series taken with poor imaging conditions.<br><br>Note: ccc values outputed to the command window by Protomo during alignment are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string selection).',
		'protomo_r5_corr_mode' : 'Correlation mode for Round 5, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl).<br><br>xcf: Conventional cross-correlation.<br><br>mcf: Mutual correlation function. mcf is less biased towards strong low-frequency components.<br><br>pcf: Phase only correlation function. pcf ignores the amplitude of the Fourier coefficients and only aligns based on phase. pcf might be useful in Refinements because it requires accurate geometric parameters as a starting point.<br><br>dbl: Phase doubled correlation. dbl doubles the peak shift allowing for more accurate alignments especially on tilt-series taken with poor imaging conditions.<br><br>Note: ccc values outputed to the command window by Protomo during alignment are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string selection).',
		...
		'corrimageinfo_refine' : 'Correlation peaks for each iteration are displayed here for quick refinement evaluation. Well-aligned reconstructions produce a point-like correlation peak video where the peak does not wander more than a few pixels from the center if the video. Excluded images are not included.<br><br>To view depicton and diagnostics for an individual iteration, click on the corresponding correlation peak image or title.',
		...
		'quality_assessment' : 'The left plot shows the sum of the average correction factors and their standard deviations for each iteration. Generally lower is better.<br><br>The top right plot shows the estimation of the tilt azimuth for each iteration.<br><br>The bottom right plot shows the estimate of the tilt angle, theta, for each iteration. An explanation of theta can be found in the Protomo User Guide (top right of this webpage) and in the Protomo citation at the bottom of this webpage.',
