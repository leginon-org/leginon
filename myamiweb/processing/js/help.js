...
/******* IMAGIC terms ********/
		...
		'protomo_create_reconstruction' : 'Create a reconstruction after Coarse Alignment for depiction as a video on the next page.<br><br>If this option and the Create Tilt-Series Videos option are set to false, the options below will do nothing. (type: true/false).',
		'protomo_create_reconstruction2' : 'Create reconstructions after alignments for depiction as a video on the next page.<br><br>If this option and the Create Tilt-Series Video option are set to false, the options below will do nothing. (type: true/false).',
...
**/
	...
	'protomo' : {
		...
		'region_x' : 'Pixels in x to use for region matching. Default: 60% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'region_y' : 'Pixels in y to use for region matching. Default: 60% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r1_region_x' : 'Pixels in x to use for region matching for Round 1. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r2_region_x' : 'Pixels in x to use for region matching for Round 2. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r3_region_x' : 'Pixels in x to use for region matching for Round 3. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r4_region_x' : 'Pixels in x to use for region matching for Round 4. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r5_region_x' : 'Pixels in x to use for region matching for Round 5. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r1_region_y' : 'Pixels in y to use for region matching for Round 1. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r2_region_y' : 'Pixels in y to use for region matching for Round 2. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r3_region_y' : 'Pixels in y to use for region matching for Round 3. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r4_region_y' : 'Pixels in y to use for region matching for Round 4. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'r5_region_y' : 'Pixels in y to use for region matching for Round 5. Default: 50% Raw Image size. This number will be binned by the requested sampling before alignment (type: int).',
		'sampling' : 'Sampling rate of Raw Images (type: real >= 1 and <= 15).',
		'r1_sampling' : 'Sampling rate of Raw Images for Round 1 (type: real >= 1 and <= 15).',
		'r2_sampling' : 'Sampling rate of Raw Images for Round 2 (type: real >= 1 and <= 15).',
		'r3_sampling' : 'Sampling rate of Raw Images for Round 3 (type: real >= 1 and <= 15).',
		'r4_sampling' : 'Sampling rate of Raw Images for Round 4 (type: real >= 1 and <= 15).',
		'r5_sampling' : 'Sampling rate of Raw Images for Round 5 (type: real >= 1 and <= 15).',
		'auto_r1_sampling' : 'Sampling rate of Raw Images for Round 1 (type: real >= 1 and <= 15).',
		'auto_r2_sampling' : 'Sampling rate of Raw Images for Round 2 (type: real >= 1 and <= 15).',
		'auto_r3_sampling' : 'Sampling rate of Raw Images for Round 3 (type: real >= 1 and <= 15).',
		'auto_r4_sampling' : 'Sampling rate of Raw Images for Round 4 (type: real >= 1 and <= 15).',
		'auto_r5_sampling' : 'Sampling rate of Raw Images for Round 5 (type: real >= 1 and <= 15).',
		'auto_r6_sampling' : 'Sampling rate of Raw Images for Round 6 (type: real >= 1 and <= 15).',
		'auto_r7_sampling' : 'Sampling rate of Raw Images for Round 7 (type: real >= 1 and <= 15).',
		'auto_r8_sampling' : 'Sampling rate of Raw Images for Round 8 (type: real >= 1 and <= 15).',
