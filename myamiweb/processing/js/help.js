...
/******* IMAGIC terms ********/
		...
		'protomo_logging' : 'Enable diagnostic terminal output (type: true/false).',
		...
		'protomo_corr_mode' : 'Correlation mode, standard (xcf), mutual (mcf), phase only (pcf), phase doubled (dbl). Note: ccc values outputed during alignment to the command window by Protomo are normalized to xcf ccc values; mcf, pcf, and dbl ccc values are not normalized to 1 (type: string).',
		...
		'maskparam_info' : 'Filters and Apodization are applied inside the region covered by the mask.',
		...
		'reconimageinfo_coarse' : 'This is a slice-through of the binned reconstruction for depiction. You should be able to see the large, high contrast objects present in your tomogram.',
...
**/
	...
	'protomo' : {
		...
		'r1_sampling' : 'Sampling rate of Raw Images for Round 1. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'r2_sampling' : 'Sampling rate of Raw Images for Round 2. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'r3_sampling' : 'Sampling rate of Raw Images for Round 3. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'r4_sampling' : 'Sampling rate of Raw Images for Round 4. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'r5_sampling' : 'Sampling rate of Raw Images for Round 5. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r1_sampling' : 'Sampling rate of Raw Images for Round 1. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r2_sampling' : 'Sampling rate of Raw Images for Round 2. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r3_sampling' : 'Sampling rate of Raw Images for Round 3. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r4_sampling' : 'Sampling rate of Raw Images for Round 4. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r5_sampling' : 'Sampling rate of Raw Images for Round 5. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r6_sampling' : 'Sampling rate of Raw Images for Round 6. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r7_sampling' : 'Sampling rate of Raw Images for Round 7. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		'auto_r8_sampling' : 'Sampling rate of Raw Images for Round 8. It is recommended to keep this value 10 or below (type: real >= 1 and <= 15).',
		...
		'lowpass_apod_x' : 'Lowpass apodization filter (x) for rectangular and ellipsoidal masks, in angstroms (type: float).',	
		'lowpass_apod_y' : 'Lowpass apodization filter (y) for rectangular and ellipsoidal masks, in angstroms (type: float).',			
		'highpass_apod_x' : 'Highpass apodization filter (x) for rectangular and ellipsoidal masks, in angstroms (type: float).',		
		'highpass_apod_y' : 'Highpass apodization filter (y) for rectangular and ellipsoidal masks, in angstroms (type: float).',
		...
		'raw_path' : 'Full path to raw image files. Use if Appion doesn\'t find raw images automatically. If this option is used, then you will also need to place your own \'series%04d<tiltseriesnumber>.tlt\' file in the \'Run name\' directory if Leginon cannot query the Raw Image metadata (type: string).',		
		...
		'kernel_x' : 'Filter window size (x), in pixels (type: int).',			
		'kernel_y' : 'Filter window size (y), in pixels (type: int).',	
		'r1_kernel_x' : 'Filter window size (x) for Round 1, in pixels (type: int).',
		'r2_kernel_x' : 'Filter window size (x) for Round 2, in pixels (type: int).',
		'r3_kernel_x' : 'Filter window size (x) for Round 3, in pixels (type: int).',
		'r4_kernel_x' : 'Filter window size (x) for Round 4, in pixels (type: int).',
		'r5_kernel_x' : 'Filter window size (x) for Round 5, in pixels (type: int).',
		'r1_kernel_y' : 'Filter window size (y) for Round 1, in pixels (type: int).',
		'r2_kernel_y' : 'Filter window size (y) for Round 2, in pixels (type: int).',
		'r3_kernel_y' : 'Filter window size (y) for Round 3, in pixels (type: int).',
		'r4_kernel_y' : 'Filter window size (y) for Round 4, in pixels (type: int).',
		'r5_kernel_y' : 'Filter window size (y) for Round 5, in pixels (type: int).',
		...
		'correlation_size_x' : 'Size (x) of cross correlation peak image, in pixels. Size is independent of sampling (type: int).',		
		'correlation_size_y' : 'Size (y) of cross correlation peak image, in pixels. Size is independent of sampling (type: int).',		
		...
		'logging' : 'Enable diagnostic terminal output (type: true/false).',		
		...
		'gridsearch_limit' : 'Gridseach +-angle limit, in degrees, for Coarse Alignment. To do a translational alignment only, set Gridseach +-Angle Limit to 0 and set Gridseach Angle Step Size to 1 (type: float).',		
		'gridsearch_step' : 'Gridseach angle step size, in degrees, for Coarse Alignment (type: float).',
		...
		'video_type' : 'Depiction videos for correlation peaks, tilt-series, and reconstructions will be made. Select HTML5 to encode videos as mp4, webm, and ogv (for compatibility). It is recommended that you only use gifs if there is any trouble with HTML5 video playback in your browser. (ffmpeg and relevant codecs are required)<br/>If HTML5 videos don\'t loop, try refreshing the webpage (type: string).',
		...
		'restart_cycle' : 'Restart a Refinement at this iteration. Only use if a Refinement has previously been run (type: int).',
