...
/******* IMAGIC terms ********/
		...
		'images_per_volume' : 'If using EMAN1 only, this parameter refers to the number of images to use for constructing each 3D map. The input averages correspond to the total \'pool\' from which a subset will be selected for analysis by cross-common lines. N different subsets will be randomly calculated and selected, where N refers to the total number of maps prior to 3D classification & refinement.',
...
**/
	...
	'simple' : {
		...
		'mask' : 'radius of external mask (in pixels)',
		'lp' : 'ow-pass limit for origami reconstruction (in Angstroms)',
