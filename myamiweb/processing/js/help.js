...
var help = {
	'appion' : {
		...
		'ace2bin' : 'Binning of the image.  This takes a power of 2 (1,2,4,8,16) Typical is 2 for ace2 estimation if the pixel size is ~ 1.0 Angstrum. This binning in real space has an effect of zooming for Ace2 processing since it is performed with the Fourier-transfomed binned image and then resampled at a dimension of 1024x1024',
		...
		'hpzero': 'signal set to zero below this frequency. For example, use 60 Angstrom for negatively-stained GroEL where the particle structure signal drops off',
		'hpone': 'signal passed at 100% above this frequency. For example, use 30 Angstrom for negatively-stained GroEL where ctf dominates the signal.',
