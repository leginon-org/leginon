...
echo "<TR><TD>Assessed Images: </TD><TD>".$assessedimgs."</TD></TR>\n";
echo "<TR><TD COLSPAN='2' BGCOLOR='#CCCCCC'></TD></TR>";
echo "<TR><TD>Rejected Images: </TD><TD>".$rejectimgs." (".round(100.0*$rejectimgs/$assessedimgs,1)."%)</TD></TR>\n";
echo "<TR><TD>Hidden Images: </TD><TD>".$hiddenimgs." (".round(100.0*$hiddenimgs/$assessedimgs,1)."%)</TD></TR>\n";
echo "<TR><TD><B>Total Rejected Images:</B> </TD><TD>".$totalrejectimgs." (".round(100.0*$totalrejectimgs/$assessedimgs,1)."%)</TD></TR>\n";
echo "<TR><TD COLSPAN='2' BGCOLOR='#CCCCCC'></TD></TR>";
echo "<TR><TD>Keep Images: </TD><TD>".$keepimgs." (".round(100.0*$keepimgs/$assessedimgs,1)."%)</TD></TR>\n";
echo "<TR><TD>Exemplar Images: </TD><TD>".$exemplarimgs." (".round(100.0*$exemplarimgs/$assessedimgs,1)."%)</TD></TR>\n";
echo "<TR><TD><B>Total Keep Images:</B> </TD><TD>".$totalkeepimgs." (".round(100.0*$totalkeepimgs/$assessedimgs,1)."%)</TD></TR>\n";
