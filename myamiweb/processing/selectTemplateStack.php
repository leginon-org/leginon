...
echo "</td><td>\n";
echo "  <h3><a href='templateStackSummary.php?expId=$expId'>Template Stacks from Class Averages</a></h3>\n";
...
echo "</td><td>\n";
echo "  <h3><a href='templateStackSummary.php?expId=$expId'>Template Stacks from Forward Projections</a></h3>\n";
