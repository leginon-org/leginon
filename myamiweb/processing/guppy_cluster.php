...
define('C_NAME', "guppy.scripps.edu"); // name of cluster, must be single name, e.g., HOST.INSTITUTE.EDU -> HOST
...
define('C_WALLTIME_DEF', "2"); // default Wall time in hours
define('C_WALLTIME_MAX', "2"); // maximum Wall time in hours
define('C_CPUTIME_DEF', "2"); // default CPU time in hours
define('C_CPUTIME_MAX', "2"); // maximum CPU time in hours
define('C_MEMORY_MAX', "30"); // maximum memory available per node in gigabytes

define('C_APPION_BIN', "/usr/local/appion/bin/"); // location of appion scripts on cluster, must end in slash, e.g., /usr/local/appion/bin/
