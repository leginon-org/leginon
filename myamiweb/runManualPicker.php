...
function createManualPickerForm($extra=false, $title='Manual Picker Launcher', $heading='Manual Particle Selection and Editing') {
  ...
  if (!$prtlrunIds) {
	...
	echo"
		...
		<input type='submit' name='process' value='Run ManualPicker'><BR>
		<FONT COLOR='RED'>Submission will NOT run Manual Picker, only output a command that you can copy and paste into a unix shell</FONT>
		</TD>
	</TR>
	</TABLE>";
	writeBottom();
