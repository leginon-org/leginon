...
function jobForm($extra=false) {
  ...
  $javafunc = writeJavaPopupFunctions().$javafunc;
  writeTop("Eman Job Generator","EMAN Job Generator",$javafunc);
  // write out errors, if any came up:
  if ($extra) {
    echo "<FONT COLOR='RED'>$extra</FONT>\n<HR>\n";
  ...
  Job Name: <INPUT TYPE='text' NAME='jobname' VALUE='$jobname' SIZE=50><BR/><BR/>";
...
<TR>
  <TD><A HREF=\"javascript:infopopup('nodes')\">Nodes:</A></TD>
...
<TR>
  <TD BGCOLOR='$bgcolor'>ang:
    <INPUT TYPE='text' NAME='$angn' SIZE='2' VALUE='$ang'></TD>
  <TD BGCOLOR='$bgcolor'>mask:
    <INPUT TYPE='text' NAME='$maskn' SIZE='4' VALUE='$mask'></TD>
  <TD BGCOLOR='$bgcolor'>imask:
    <INPUT TYPE='text' NAME='$imaskn' SIZE='4' VALUE='$imask'></TD>
  <TD BGCOLOR='$bgcolor'>sym:
    <INPUT TYPE='text' NAME='$symn' SIZE='5' VALUE='$sym'></TD>
  <TD BGCOLOR='$bgcolor'>hard:
    <INPUT TYPE='text' NAME='$hardn' SIZE='3' VALUE='$hard'></TD>
  <TD BGCOLOR='$bgcolor'>classkeep:
    <INPUT TYPE='text' NAME='$classkeepn' SIZE='4' VALUE='$classkeep'></TD>
  <TD BGCOLOR='$bgcolor'>classiter:
    <INPUT TYPE='text' NAME='$classitern' SIZE='2' VALUE='$classiter'></TD>
  <TD BGCOLOR='$bgcolor'>filt3d:
    <INPUT TYPE='text' NAME='$filt3dn' SIZE='4' VALUE='$filt3d'></TD>
</TR>
<TR>
  <TD BGCOLOR='$bgcolor'>shrink:
    <INPUT TYPE='text' NAME='$shrinkn' SIZE='2' VALUE='$shrink'></TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$mediann' $median>median</TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$phaseclsn' $phasecls>phasecls</TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$refinen' $refine>refine</TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$goodbadn' $goodbad>goodbad</TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$eotestn' $eotest>eotest</TD>
  <TD BGCOLOR='$bgcolor'>
    <INPUT TYPE='checkbox' NAME='$corann' $coran>coran</TD>
...
function writeJavaPopupFunctions () {
  ...
  function infopopup(infoname){
    ...
    newwindow.document.write('<HTML><BODY>');
    if (infoname=='nodes'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='runid'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='nowait'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='background'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='shuffle'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='limit'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='continue'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
    } elseif (infoname=='commit'){
      newwindow.document.write('If images have been assessed checking "
      ."this will included REJECTED images from the assessment when "
      ."unchecked only unassessed and GOOD images will be processed. "
      ."Unchecking this saves computer time.');
