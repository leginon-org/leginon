...
require_once('setupUtils.inc');
	...
	$template->wizardHeader("Step 1: Define web tools base variables");
...
?>
	...
	<form name='wizard_form' method='POST' action='setupEmail.php'>
		<input type="hidden" name="porject_name" value="<?php echo PROJECT_NAME; ?>" />
		...
		<input type="text" size=50 name="project_title" value="Appion and Leginon DB tools" /><br /><br />
		<br />
