...
?>
	...
	?>
		...
		<input type="radio" name="enable_login" value="false" checked="yes" onclick="setLogin(this)" />&nbsp;&nbsp;NO<br />
		<input type="radio" name="enable_login" value="true" onclick="setLogin(this)" />&nbsp;&nbsp;YES<br />
		<br />
		<h3>Enter outgoing email subject:</h3>
		<p>example: AMI - The Scripps Research Institute</p>
		<input type="text" size=50 name="email_title" readOnly="true" style="background:#eeeeee" value="" /><br /><br />
		<br />
		...
		<input type="text" size=35 name="admin_email" readOnly="true" style="background:#eeeeee"  value="" /><br /><br />
		<br />
		...
		&nbsp;<input type="radio" name="enable_smtp" value="false" disabled onclick="setReadOnly_SMTP(this)" />&nbsp;&nbsp;I want to use regular PHP mail.<br />
		&nbsp;<input type="radio" name="enable_smtp" value="true" disabled onclick="setReadOnly_SMTP(this)" />&nbsp;&nbsp;I want to use our SMTP server.<br /><br />
		<br />
		<h3>Enter your SMTP host name:</h3>
		<p>example: mail.school.edu</p>
		<input type="text" size=35 name="smtp_host" readOnly="true" style="background:#eeeeee" /><br /><br />
		<br />
		...
		&nbsp;<input type="radio" name="smtp_auth" value="false" disabled onclick="setReadOnly_AUTH(this)" />&nbsp;&nbsp;No.<br />
		&nbsp;<input type="radio" name="smtp_auth" value="true" disabled onclick="setReadOnly_AUTH(this)" />&nbsp;&nbsp;Yes.<br /><br />
		<br />
		...
		&nbsp;Username: &nbsp;<input type="text" size=20 name="smtp_username" readOnly="true" style="background:#eeeeee" /><br /><br />
		&nbsp;Password: &nbsp;<input type="text" size=20 name="smtp_password" readOnly="true" style="background:#eeeeee" /><br /><br />
		<br />
