...
class SettingsDialog(gui.wx.Acquisition.SettingsDialog):
    def initialize(self):
        ...
        self.widgets['tilt1'] = FloatEntry(self, -1, chars=6, value='0.0')
        sizer.Add(self.widgets['tilt1'], (0,1), (1,1))

        label = wx.StaticText(self, -1, 'Tilt 2')
        sizer.Add(label, (1, 0), (1, 1))
        self.widgets['tilt2'] = FloatEntry(self, -1, chars=6, value='0.0')
        sizer.Add(self.widgets['tilt2'], (1,1), (1,1))
