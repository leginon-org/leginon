...
registerNodeClass('calibrationlibrary', 'PickleCalibrationLibrary')
registerNodeClass('calibrationlibrary', 'DBCalibrationLibrary')
...
registerNodeClass('fftviewer', 'FFTViewer')
