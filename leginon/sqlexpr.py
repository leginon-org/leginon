...
class AlterTable(SQLExpression):
	...
	def sqlRepr(self):
		...
		if not self.column:
			...
			alter = "ALTER TABLE %s %s %s" % (backquote(self.table), self.operation, backquote(self.column['Field']))
		elif self.operation=='ADD':
			alter = "ALTER TABLE %s %s %s %s %s %s" % (backquote(self.table), self.operation, backquote(self.column['Field']), self.column['Type'], default, str_null)
		elif self.operation=='CHANGE':
			alter = "ALTER TABLE %s %s %s %s %s %s %s" % (backquote(self.table), self.operation, backquote(self.column['Field']), backquote(self.column['Field']), self.column['Type'], default, str_null)
		return alter
