/*----------------------------------------------------------------------------*
*
*  mask_wedge.c  -  array: mask operations
*
*-----------------------------------------------------------------------------*
*
...

{
  ...
  switch ( type ) {
    case TypeReal:  status = exception( MaskWedgeReal( dim, len, addr, A, b, param ) ); break;
    case TypeCmplx: status = exception( MaskWedgeCmplx( dim, len, addr, A, b, param ) ); break;
