/*----------------------------------------------------------------------------*
*
*  mask_ellips.c  -  array: mask operations
*
*-----------------------------------------------------------------------------*
*
...

{
  ...
  switch ( type ) {
    case TypeReal:  status = exception( MaskEllipsReal( dim, len, addr, A, b, param ) ); break;
    case TypeCmplx: status = exception( MaskEllipsCmplx( dim, len, addr, A, b, param ) ); break;
