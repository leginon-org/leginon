/*----------------------------------------------------------------------------*
*
*  mat3rot.c  -  3 x 3 matrix operations
*
*-----------------------------------------------------------------------------*
*
...

{
  ...
  A[0][1] =  sinpsi * cosphi  +  cospsi * costheta * sinphi;
  A[0][2] =                               sintheta * sinphi;
  A[1][0] = -cospsi * sinphi  -  sinpsi * costheta * cosphi;
  A[1][1] = -sinpsi * sinphi  +  cospsi * costheta * cosphi;
  A[1][2] =                               sintheta * cosphi;
