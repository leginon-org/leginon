/*----------------------------------------------------------------------------*
*
*  stringparseint64.c  -  core: character string operations
*
*-----------------------------------------------------------------------------*
*
...
static int64_t StringParseGetVal
                (char c,
                 int64_t base)
...

{
  ...
  if ( str == NULL ) {
    if ( param == NULL ) {
      ...
      dstsize = sizeof( int64_t ); goto exit;
    }
  }
