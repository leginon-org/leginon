/*----------------------------------------------------------------------------*
*
*  stringparseuint64.c  -  core: character string operations
*
*-----------------------------------------------------------------------------*
*
...
static uint64_t StringParseGetVal
                (char c,
                 uint64_t base)
...

{
  ...
  if ( str == NULL ) {
    if ( param == NULL ) {
      ...
      dstsize = sizeof( uint64_t ); goto exit;
    }
  }
