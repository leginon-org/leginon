...
class UpdateLib:
	...
	def getUpdateRevisionSequence(self,svn_branch):
		...
		if svn_branch == 'trunk':
			schema_revisions = [12857,13713,14077,14891,15069,15526,15653,16182,16607,17035,17111,17224,17561,17562,17617,17812,17813,17916,17982,18000,18034]
			appion_only_revisions = [15248,15251,15293,15961,16412,16446,17035,17311]
