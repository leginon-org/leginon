...
class DEApolloCamProcessing(apDDprocess.DDFrameProcessing):
        def __init__(self,wait_for_new=False):
                super(DEApolloCamProcessing,self).__init__(wait_for_new)
        ...
        def getRawFrameDirFromImage(self,imagedata):
                '''
                DE Apollo raw frames are saved as image stack for feeding into gpu program.
        ...
        def loadOneRawFrame(self,rawframe_path,frame_number):
                ...
                if self.getRawFrameType() == 'singles':
                        return super(DEApolloCamProcessing,self).loadOneRawFrame(rawframe_path,frame_number)
                '''
