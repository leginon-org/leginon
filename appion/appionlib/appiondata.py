...
class ApProtomoAlignmentParamsData(Data):
	def typemap(cls):
		return Data.typemap() + (
			...
			('region_x', int),
			('region_y', int),
			('lowpass_diameter_x', float),
			('lowpass_diameter_y', float),
			('lowpass_apod_x', float),
			('lowpass_apod_y', float),
			('highpass_diameter_x', float),
			('highpass_diameter_y', float),
			('highpass_apod_x', float),
			('highpass_apod_y', float),
			('thickness', float),
			('param', float),
			('sampling', float),
			('map_sampling', float),
			...
			("max_shift", float),
			("image_apodization_x", float),
			("image_apodization_y", float),
			("reference_apodization_x", float),
			("reference_apodization_y", float),
			("corr_mode", str),
			("correlation_size_x", int),
			("correlation_size_y", int),
			("peak_search_radius_x", float),
			("peak_search_radius_y", float),
			("cmdiameter_x", float),
			("cmdiameter_y", float),
			("map_size_x", int),
			("map_size_y", int),
			("map_size_z", int),
			("map_lowpass_diameter_x", float),
			("map_lowpass_diameter_y", float),
			("image_file_type", str),
			("filename_prefix", str),
			('cachedir', str),
			('protomo_outdir', str),
			...
			("window_area", float),
			("orientation", bool),
			("orientation_switch", int),
			("azimuth", bool),
			("azimuth_switch", int),
			("elevation", bool),
			("elevation_switch", int),
			("rotation", bool),
			("rotation_switch", int),
			("scale", bool),
			("scale_switch", int),
			...
			("mask_apod_y", float),
			("coarse", str),
			("gridsearch_limit", float),
			("gridsearch_step", float),
			("create_tilt_video", str),
			("create_reconstruction", str),
			("show_window_size", str),
			("keep_recons", str),
			("tilt_clip", str),
			("video_type", str),
			("restart_cycle", int),
			...
			("recon_webm", str),
			("qa_gif", str),
			("corr_plot_coa_gif", str),
			("corr_plot_cofx_gif", str),
			("corr_plot_cofy_gif", str),
			("corr_plot_rot_gif", str),
			("azimuth_gif", str),
			("theta_gif", str),
...
class ApProtomoAlignerParamsData(Data):
	def typemap(cls):
		return Data.typemap() + (
			...
			('protomo', ApProtomoParamsData),
			('refine_cycle', ApProtomoAlignmentParamsData),
			('good_cycle', ApProtomoAlignmentParamsData),
			('good_start', int),
			('good_end', int),
			('description', str),
			('hidden', bool),
...
class ApTomoAlignmentRunData(Data):
	def typemap(cls):
		return Data.typemap() + (
			...
			('refineProtomoParams', ApProtomoAlignmentParamsData),
			('sessionname', str),
			('rundir', ApPathData),
			('runname', str),
			('description', str),
