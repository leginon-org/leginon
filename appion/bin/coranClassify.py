...
class NoRefAlignScript(appionScript.AppionScript):
	...
	#=====================
	def setOutDir(self):
		alignstackdata = self.appiondb.direct_query(appionData.ApAlignStackData, self.params['alignstackid'])
	...
	def getAlignedStack(self):
		return self.appiondb.direct_query(appionData.ApAlignStackData, self.params['alignstackid'])
