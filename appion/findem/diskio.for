...
C
C     $Id: diskio.for,v 1.1 2007-02-15 00:17:32 vossman Exp $
C     
C_BEGIN_CCPLIB
...
C
      ...
      CALL UGTUID(USRNAM)
C      WRITE (ERRSTR,'(1X,A,I2)') '(Q)QOPEN allocated # ',IUNIT
C     CALL QPRINT(1,ERRSTR)
C      ERRSTR = 'User:   '//USRNAM//' Logical Name: '//LNAME
C     CALL QPRINT(1,ERRSTR)
C      ERRSTR = 'Status: '//MODES(JSTAT)//' Filename: '//FNAME
C     CALL QPRINT(1,ERRSTR)
