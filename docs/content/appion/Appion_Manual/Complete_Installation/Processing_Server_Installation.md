...
## Follow these steps unique to Appion
...
Developers Only - CentOS 6 specific instructions for running the svn trunk:

-   [CentOS 6 instructions](/appion/CentOS6_installation)

[< File Server Setup Considerations](/appion/Appion_Manual/Complete_Installation/File_Server_Setup_Considerations) | [Web Server Installation >](/appion/Appion_Manual/Complete_Installation/Web_Server_Installation)
