## Important: Upgrade to 3.0 includes a change in ctf angle of stigmatism definition. Once you've completed the upgrade, you should not use older versions on the same Appion processing database.

## Upgrade your web server and processing server
...
## Download myami 3.0.x source code
