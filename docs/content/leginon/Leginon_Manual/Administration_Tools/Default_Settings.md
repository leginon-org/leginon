...
- After restarting Leginon with the same application, the settings that were changed should be reverted.
- Only those in administrator group or the user in question can do this. A user with Guest permissions may not revert settings.



[< More about Groups](/leginon/Leginon_Manual/Administration_Tools/More_about_Groups) | [Applications >](/leginon/Leginon_Manual/Administration_Tools/Applications)
