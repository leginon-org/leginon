...
## Download myami 3.1 source code
    ...
    svn co http://emg.nysbc.org/svn/myami/branches/myami-3.1/
...
## install the 3.1 version of pyami as it is done on processing server.
...
[How to Update from v3.0 (Instrument Computer) >](/leginon/Leginon_Manual/Upgrade_to_Leginon_System_version_31_from_version_30/How_to_Update_from_v30_Instrument_Windows_Computer)
