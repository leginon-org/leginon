...
## Download myami-3.4 source code

    git clone -b myami-3.4 http://emg.nysbc.org/git/myami myami-3.4
...
## install the 3.4 version of pyami as it is done on processing server.
...
[How to Update from v3.3 (Instrument Computer) >](/leginon/Leginon_Manual/Upgrade_to_Leginon_System_version_34_from_version_33/How_to_Update_from_v33_Instrument_Windows_Computer)
