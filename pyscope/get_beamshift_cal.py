...
input('hit enter when done. The beam shift will be recorded')
...
print('--------')
camlength = int(input('Enter average number of pixels of the camera: '))
print('---------------------------------------------------------------')
...
input('hit enter or close window to finish.')
time.sleep(2)
print('done')
